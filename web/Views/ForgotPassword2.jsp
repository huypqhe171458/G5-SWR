                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" placeholder="New password " name="email" required="">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Password Confirmation<span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" placeholder="Password confirmation" name="otp" required="">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="d-grid">
