<%-- 
    ...
    Created on : Jun 10, 2024, 11:33:20 PM
    Author     : huyca
--%>
                        ...
                        <div class="d-md-flex justify-content-between">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="patients">Product</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="number" id="number" type="text" class="form-control" placeholder="Description :">
                                                </div>                                                                               
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control department-name select2input">
                                                        ...
                                                        <option value="GA">Category 6</option>
                                                        <option value="UR">Category 7</option>
                                                        <option value="NE">Category 8</option>
                                                    </select>
                                                </div>
                                            </div><!--end col-->
                                        </div><!--end row-->
