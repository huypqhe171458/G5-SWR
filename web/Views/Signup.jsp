<%-- 
    Document   : Signup.jsp
    Created on : Jun 10, 2024, 10:13:06 PM
    Author     : huyca
--%>
...
<!DOCTYPE html>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-150 d-table w-100 bg-light" style="background: url('${pageContext.request.contextPath}/images/bg/bg-lines-one.png') center;">
            <div class="container">
